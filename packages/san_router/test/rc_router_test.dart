...
void main() {
  group('RcRoute', () {
    test('generateRoute', () {
      final url = SanRoute.generateRoute(
        '/test',
      );
      expect(url, '/test');
    });
  ...
  group('RcRoutes', () {
    group('valid', () {
      test('empty', () {
        final rcRoutes = SanRoutes(routes: null);
...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final routeParams = Provider.of<SanRouteParameters>(context, listen: false);
    return Center(
      child: Column(
        children: <Widget>[
